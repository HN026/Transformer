...
# Combining the Encoder and the Decoder layers to create the complete transformer network:
...
# Manual training using a custom dataset 
src_vocab_size = 5000
tgt_vocab_size = 5000
d_model = 512
num_heads = 8
...
#Training the model on the randomly generated data:
...
# Evaulating the transformer model: 
transformer.eval()
